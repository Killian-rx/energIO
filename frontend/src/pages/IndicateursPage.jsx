            ...
            <div className="space-y-4">
              ...
              {normalises.length === 0 ? (
                ...
                <>
                  <div className="card overflow-x-auto p-0">
                    <table className="table-auto w-full">
                      <thead><tr>
                        ...
                        <th>Élec. (kWh)</th><th>Gaz</th><th>kWh/m²</th>
                      </tr></thead>
                      <tbody>
                        {normalises.map(s => (
                          <tr key={s.site_id}>
                  ...
                  <div className="card">
                    <h3 className="text-sm font-semibold text-gray-700 mb-4">Consommation normalisée (kWh/m²)</h3>
          ...
          {tab === 2 && (
            <div className="space-y-4">
              ...
              {anomalies.length === 0 ? (
                ...
                anomalies.map(a => {
                  const aUnit = ENERGIE_UNITS[a.type_energie] || 'kWh';
                  return (
                    <div key={a.compteur_id} className="card border-l-4 border-amber-400">
                      ...
                      {a.anomalies.map((ano, i) => (
                        <div key={i} className="text-sm text-gray-700 bg-amber-50 rounded px-3 py-2 mb-2">
                          ...
                          <span className="text-gray-500"> · {fmtVal(ano.valeur, aUnit)}</span>
          ...
          {tab === 3 && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {tendances.map(t => {
                  const tUnit = ENERGIE_UNITS[t.type_energie] || 'kWh';
                  return (
                      ...
                      <div className="grid grid-cols-3 gap-2 text-xs">
                        <div className="bg-gray-50 rounded p-2 text-center">
                          ...
                          <p className="font-mono font-medium text-gray-700">
                            {t.tendance.a > 0 ? '+' : ''}{t.tendance.a} {tUnit}/mois
                          </p>
                        </div>
                        <div className="bg-gray-50 rounded p-2 text-center">
